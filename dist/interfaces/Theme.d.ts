...
export type TemplateData = {
    ...
    custom?: string;
    modules: (CategoriesData | BannerData | ProductsData | CookiesData | FooterData | AccordionsData | ImagePlusTextData | ParagraphData | MidiaData | GridItemAreaData | GenericTableData | BannerVariantData | BannerWJJCData | PassBenefitData)[];
};
export type Theme = {
...
export declare enum CoinsType {
    ETH = "ETH",
    MATIC = "MATIC",
    LOYALTY = "LOYALTY"
}
export declare enum WalletsOptions {
    CUSTODY = "custody",
    METAMASK = "metamask",
    ALL = "all"
}
...
export declare enum AlignmentEnum {
    LEFT = "left",
    CENTER = "center",
    RIGHT = "right"
}
...
export interface SpecificBannerInfo {
    ...
    sideImagePosition?: 'left-center' | 'right-center' | 'center-center' | 'center-top' | 'center-bottom' | 'left-bottom' | 'right-bottom' | 'left-top' | 'right-top';
    ...
    titleTextAlign?: 'start' | 'end' | 'left' | 'right' | 'center' | 'justify' | 'match-parent';
...
export declare enum CardSearchEnum {
    FEATURED = "featured",
    MOST_SEEN = "mostSeen",
    CHEAPER = "cheaper"
}
export declare enum CardTypesEnum {
    DYNAMIC = "dynamic",
    CONTENT = "content"
}
export declare enum CardsOrderingEnum {
    NAME = "name",
    VALUE = "value",
    RELEVANCE = "relevance"
}
export declare enum CardLayoutDisposition {
    CARROUSEL = "carrousel",
    GRID = "grid"
}
...
declare enum ImagePositionEnum {
    LEFT = "left",
    RIGHT = "right"
}
export declare enum ModulesType {
    HEADER = "Header",
